...
const AdminSidebar = ()=>{
   useEffect(() => {
          ...
          link.id = 'pagestyle';
          link.rel = 'stylesheet';
          link.href = '/admin-assets/css/soft-ui-dashboard.css?v=1.1.0';
          document.head.appendChild(link);
      
          // Optional: Cleanup to remove it when component unmounts
          return () => {
            const existingLink = document.getElementById('pagestyle');
            if (existingLink) {
              existingLink.remove();
            }
          };
    ...
    return(
        ...
        <div className="sidenav-header">
          ...
          <a className="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
            <img src="/admin-assets/img/logo-ct-dark.png" className="navbar-brand-img h-100" alt="main_logo" />
        ...
        <div className="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
               <Link to="/admin/categories/create" className="nav-link">
                ...
                <span className="nav-link-text ms-1">Create Category</span>
                </Link>
            </li>
            <li className="nav-item">
